...
public:
    ...
    void setupUi(QMainWindow *jailbird)
    {
        ...
        exploit_tools_tab = new QWidget();
        exploit_tools_tab->setObjectName(QStringLiteral("exploit_tools_tab"));
        exploit->addTab(exploit_tools_tab, QString());
    ...
    void retranslateUi(QMainWindow *jailbird)
    {
        ...
        exploit->setTabText(exploit->indexOf(exploit_tools_tab), QApplication::translate("jailbird", "Exploit toolkits", 0));
